...
Scenario: no ratings selected
  # enter step(s) to uncheck all of the ratings
...
Scenario: all ratings selected
  # enter step(s) to check all the ratings
...
Scenario: no ratings selected 2
  # enter step(s) to uncheck all the ratings
  When I uncheck the following ratings: G, PG, PG-13, R, NC-17
  # enter step to "submit" the search form on the homepage
  And  I press "ratings_submit"
  # check that no movies were found
